...
staggered nature of income might cause acute poverty in certain months, inducing borrowing, which is measured over a longer 
period, causing disparity in comparison.
```
